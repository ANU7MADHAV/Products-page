...
const NavBar = () => {
  return (
    <>
      <div className="relative hidden h-[80px] w-screen xl:flex ">
      ...
      <div className="flex h-[60px] w-screen text-white xl:hidden">
        <div className="min-w-[80px] items-start bg-white"></div>

        <div className="flex-1 bg-blue-200/90 md:flex-grow lg:flex-grow xl:flex-grow">
          <div className="relative right-[95px] z-10 h-[50px] w-[200px] -rotate-45 bg-white text-blue-500"></div>
        </div>
      </div>
    </>
  );
